...
```matlab
theta = [0 -30 0]*pi/180; % three angles for ZXZ rotation of NP
shiftNP = [50 50 60.2];   % nanoparticle (x,y,z) center position after rotation
